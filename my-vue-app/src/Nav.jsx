    ...
    return (
        <nav className={`nav-container ${scrolled ? 'scrolled' : ''}`}>
            ...
            <div className={`navbar ${menuAtivo ? "ativo" : ""}`}>
                <ul>
                    ...
                    <li className="nav-cta-mobile">
                        <a href={`https://wa.me/5514998659046?text=${encodeURIComponent("Vim pelo site, gostaria de vender meu veículo financiado, pode me orientar ?")}`} target='_blank' rel='noopener noreferrer' className="btn-contact">
                            Contato
                        </a>
                    </li>
                </ul>
            ...
            <div className="nav-actions">
                <a href={`https://wa.me/5514998659046?text=${encodeURIComponent("Vim pelo site, gostaria de vender meu veículo financiado, pode me orientar ?")}`} target='_blank' rel='noopener noreferrer' className="btn-contact-desktop">
